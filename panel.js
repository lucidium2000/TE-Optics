...
(function () {
  ...
  const STYLES = `
    ...
    .tep-test-actions { display: flex; gap: 4px; align-items: center; }
      ...
      card.innerHTML = `
        <div class="tep-test-card-header">
          ...
          <div class="tep-test-actions">
            ...
            <button type="button" class="tep-test-action-icon" data-action="edit" title="Edit" aria-label="Edit">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
